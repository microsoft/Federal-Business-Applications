...
| contMainTranscriptVert <br>&nbsp;↳contMainBodyTranscriptHoriz<br>&nbsp;&nbsp;↳contMainBodySummaryTranscriptVert | **[txtSummaryTranscript](#txtSummaryTranscript)** | Used to display and edit AI generated summary of transcript|
| contMainTranscriptVert<br>&nbsp;↳contMainBodyTranscriptHoriz<br>&nbsp;&nbsp;↳contMainBodyTranscriptVert | **[audRecordingPlayback](#audRecordingPlayback)** | Used to playback the original audio (stored in Azure Blob Storage) |
| contMainTranscriptVert<br>&nbsp;↳contFooterTranscriptHoriz | **[btnEdit_Transcript](#btnEdit_Transcript)** | Used to put screen into edit mode |
| contMainTranscriptVert<br>&nbsp;↳contFooterTranscriptHoriz | **[btnSave_Transcript](#btnSave_Transcript)** | Used to save changes |
| contMainTranscriptVert<br>&nbsp;↳contFooterTranscriptHoriz | **[btnCancel_Transcript](#btnCancel_Transcript)** | Resets screen to display mode without saving changes|
| **[txtCurrentPhrase_Transcript](#txtCurrentPhrase_Transcript)** |  | Displays the text of the currently selected phrase |
| **[lblCurrentSpeaker_Transcript](#lblCurrentSpeaker_Transcript)** |  | Displays either Speaker name (if available) or speaker number (as generated by Azure Speech to Text) |
| **[drpSelectSpeaker_Transcript](#drpSelectSpeaker_Transcript)** |  | Used to select speaker from **Speakers** table |
| **[icoClearSelectSpeaker_Transcript](#icoClearSelectSpeaker_Transcript)** |  | Resets **[drpSelectSpeaker_Transcript](#drpSelectSpeaker_Transcript)** |
| **[btnNewSpeaker_Transcript ](#btnNewSpeaker_Transcript )** |  | Opens the **[contPopUpUpdateAllSpeakersBg](#contPopUpUpdateAllSpeakersBg)** pop-up |
| **[btnJumpToInPoint ](#btnJumpToInPoint )** |  | |
| **[lblInPoint_Transcript ](#lblInPoint_Transcript )** |  | |
| **[lblOutpoint_Transcript:](#lblOutpoint_Transcript)** |  | |
| **[lblJumpToTime_Transcript](#lblJumpToTime_Transcript)** |  | |
| **[txtJumpToTime_Transcript ](#txtJumpToTime_Transcript )** |  | Allows user to type time code (HH:MM:SS) to jump to part of recording (and transcript) |
| **[contPopUpAddSpeaker](#contPopUpAddSpeaker)** |  | Only visible when **glbShowPopUpAddSpeaker** = true  |
| **[frmAddSpeaker ](#frmAddSpeaker )** |  | Submits new speaker name to Speakers table |
| **[btnAddSpeakerSave ](#btnAddSpeakerSave )** | |  |
| **[btnAddSpeakerCancel ](#btnAddSpeakerCancel )** | |  |
| **[contPopUpUpdateAllSpeakersBg](#contPopUpUpdateAllSpeakersBg)** |  | Is only visible when **gblShowPopUpUpdateAllSpeakers** = true   |
| **[contPopUpUpdateAllSpeakers ](#contPopUpUpdateAllSpeakers )** | |  |
